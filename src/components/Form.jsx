    ...
    <>
      <form onSubmit={handleSubmit} className="flex flex-col  pb-6">
        ...
        <div className="flex flex-col gap-3 mb-6">
          <p className="text-end text-[#002F31] font-medium cursor-pointer">
            Forget Password?
          </p>
      ...
      checked:before:flex checked:before:items-center checked:before:justify-center"
        ...
        <button
          type="submit"
          className="bg-[#BFE437] hover:bg-[#afd230] text-[#212E05] flex items-center justify-center w-full py-4 rounded-[12px] font-bold cursor-pointer duration-200"
        >
          Sign In
        </button>
      </form>
